...
public class TimeServlet extends HttpServlet {
    ...
    //TODO В index.jsp добавить функцию вывода текущего времени при начальной загрузке страницы
    public String htmlIndexFilePath = "app/src/main/webapp/index.jsp";
